...
const events = [
  {
    ...
    img: "https://images.unsplash.com/photo-1438032005730-c779502df39b?auto=format&fit=crop&w=900&q=70",
  },
  {
...
const sermons = [
  {
    ...
    date: "Jul 6, 2026",
    img: "https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=900&q=70",
  },
  {
...
function Home() {
  return (
    <>
          ...
          <div className="mt-10 -mx-5 overflow-x-auto pb-4 lg:mx-0">
            <StaggerGroup className="flex gap-6 px-5 lg:px-0">
              {events.map((e) => (
                ...
                >
                  <article className="group h-full overflow-hidden rounded-2xl border border-border bg-card transition hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10">
      ...
      {/* Stats mini strip */}
      <section className="border-y border-border bg-[var(--soft-grey)] py-16">
